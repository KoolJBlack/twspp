...
void WaypointCamera::setOriginTarget(ofNode target){
    originTarNode = target;
}

void WaypointCamera::setOriginTarget(ofVec3f position, ofQuaternion orientation){
    originTarNode.resetTransform();
    originTarNode.setPosition(position);
    originTarNode.setOrientation(orientation);
}

ofNode WaypointCamera::getOriginTarget(){
    return originTarNode;
}

void WaypointCamera::returnToOrigin(){
    curTarNode = originTarNode;
